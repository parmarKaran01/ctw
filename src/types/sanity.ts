...
export interface PricingTier {
  ...
  quarterlyPeriodUSD?: string;
  quarterlyBadgeUSD?: string;
  quarterlyPriceINR?: string;
  quarterlyPeriodINR?: string;
  quarterlyBadgeINR?: string;
  monthlyPriceUSD?: string;
  monthlyPeriodUSD?: string;
  monthlyBadgeUSD?: string;
  monthlyPriceINR?: string;
  monthlyPeriodINR?: string;
  monthlyBadgeINR?: string;
  description?: string;
  features: string[];
  ctaLabel?: string;
  order?: number;
